async function test() {
  ...
  try {
    ...
    console.log(Object.keys(pdJson));
    console.log("listid:", pdJson.listid, "listname:", pdJson.listname);
    console.log("songs length:", pdJson.list?.length);
    if(pdJson.list && pdJson.list.length > 0) {
       console.log(Object.keys(pdJson.list[0]));
    }
